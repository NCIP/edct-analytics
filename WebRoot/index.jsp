	    ...
	    <div id="help_container">
	    	...
	    	<div id="help_container_content">
			    ...
			    <fieldset id="independentQtnSet" class="selectAnswerSpan">
					<legend class="answerSpanHeader">Independent Variables</legend>
					<ul>
						<li class="none">(None selected)</li>
					</ul>
				</fieldset>
				<fieldset id="dependentQtnSet" class="selectAnswerSpan">
					<legend class="answerSpanHeader">Dependent Variables</legend>
					<ul>
						<li class="none">(None selected)</li>
					</ul>
				</fieldset>
	...
	<div id="codesiteContent">
		<div class="g-section g-tpl-170">
			<div id="gc-pagecontent">
				<script type="text/javascript">					
					google.setOnLoadCallback(preHandleCallback);
