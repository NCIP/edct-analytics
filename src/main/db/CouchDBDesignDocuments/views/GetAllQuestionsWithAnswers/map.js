function (doc) {
	...
	// Form Id
	if ( doc.formId ) {
		emit (['formid00000000000000000000000000', 'Form', doc.formId, doc.formId],1);
	}
	
	// Updated Date (timestamp)
	if ( doc.updatedDate ) {
		if ( doc.formId ){
			emit (['updatedDate000000000000000000000', 'ISO-formatted document update timestamp', doc.formId + doc.updatedDate, doc.updatedDate],1);
